...
<body>
    <p>
        ...
        <a href="report.php" class="btn-add" style="background-color: #2196F3; margin-left: 10px; text-decoration: none;">View Summary Reports</a>
    </p>
        ...
        <tbody>
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <?php 
                        $lowStockClass = ($row['stock'] < 20) ? 'class="row-low-stock"' : ''; 
                    ?>
                    <tr <?= $lowStockClass ?>>
