    ...
    <div style="display: flex; gap: 28px; align-items: center;">
        ...
        <?php else: ?>
            ...
            <?php if (isAdmin()): ?>
                ...
                <a href="register.php" style="color: <?= $current_page === 'register.php' ? '#fff' : '#a0a0b0' ?>; text-decoration: none; font-size: 14px; font-weight: 600; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='<?= $current_page === 'register.php' ? '#fff' : '#a0a0b0' ?>'">
                    Users
                </a>
            <?php endif; ?>
        <?php endif; ?>
